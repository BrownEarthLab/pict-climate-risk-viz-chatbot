...
// ---------------------------------------------------------------------------
// SDMX dynamic layer helpers (temporary home — gh issue #2 will extract)
// ---------------------------------------------------------------------------
 ...
 *
 * @param {Object} sdmxData - The SDMX-JSON payload (data.dataSets[0].observations
...
async function handleLayerRequest(layerName, res) {
  ...
  try {
    ...
    if (layerName === "sea_level") {
      ...
      // For power_gen and water_access, return region geometry directly
      result = {
        type: "FeatureCollection",
    ...
    // No cache — return error contract (503)
...
// ---------------------------------------------------------------------------
// SDMX dynamic layer route handlers (temporary home — gh issue #2 will extract)
// ---------------------------------------------------------------------------
...
// POST /api/refresh — admin endpoint to trigger manual cache refresh
